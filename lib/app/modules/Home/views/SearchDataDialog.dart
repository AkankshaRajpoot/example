...
import 'package:vishrampoint/app/modules/Home/views/widget/RoomWidget.dart';

import '../../../helpers/Global.dart';
import '../../../shared/views/layouts/MasterLayout.dart';

class SearchDataDialog extends StatelessWidget {
  ...
  SearchDataDialog({
    ...
    this.value,
    this.onChanged,
    required this.options, required this.controller,
  }) : super(key: key);

  final HomeController controller;

  // final SearchDataDialogController controller = SearchDataDialogController.instance;
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  ...
                                                  style: TextStyl.bodySm
                                                      ?.copyWith(color: controller.selectAge == 0 ? kcDanger.withOpacity(0.8) : kcBlack),
                                                ),
                                                SizedBox(
                                                  height: 5,
                                                ),
                                                        ...
                                                        return InkWell(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            decoration: BoxDecoration(
                                                              color: controller.selectAge == index + 1 ? kcInfoDark : kcInfo.withOpacity(0.15),
                                                              borderRadius: BorderRadius.circular(3),
                                                            ),
                                                            child: Text(
                                                              "${index + 1}",
                                                              style: TextStyl.bodySm?.copyWith(
                                                                color: controller.selectAge == index + 1 ? kcWhite : kcBlack,
...
class SearchDataDialogController extends GetxController {
  static SearchDataDialogController get instance {
    if (!Get.isRegistered<SearchDataDialogController>()) Get.create(() => SearchDataDialogController());
    return Get.find<SearchDataDialogController>();
  }
